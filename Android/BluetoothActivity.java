...
public class BluetoothActivity extends AppCompatActivity {
    ...
    public DeviceAdapter mNewDevlceListAdapter;
    public DeviceAdapter mPairedDevlceListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send = findViewById(R.id.messageButton);


        // Message Box
        MessageReceivedTV = findViewById(R.id.MessageReceivedTV);
    ...
    public void toggleButtonScan(View view){
        ...
        if(mBluetoothAdapter != null) {
            ...
            for(BluetoothDevice d : pairedDevices){
                ...
                mPairedDevlceListAdapter = new DeviceAdapter(this, R.layout.activity_device_view, mPairedBTDevices);
                pairedDevicesListView.setAdapter(mPairedDevlceListAdapter);
            }
        }
    }
